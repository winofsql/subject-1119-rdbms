...
SELECT
    取引先コード
FROM
    OPENDATASOURCE('Microsoft.ACE.OLEDB.12.0','Data Source="C:\app\workspace\販売管理.xls";Extended properties=Excel 12.0')...取引データ;
...
FROM
    OPENDATASOURCE('Microsoft.ACE.OLEDB.12.0','Data Source="C:\app\workspace\販売管理.xlsx";Extended properties=Excel 12.0')...取引データ
    LEFT OUTER JOIN OPENDATASOURCE('Microsoft.ACE.OLEDB.12.0','Data Source="C:\app\workspace\販売管理.xls";Extended properties=Excel 12.0')...得意先マスタ ON 取引先コード = 得意先コード
GROUP BY
    取引先コード;
